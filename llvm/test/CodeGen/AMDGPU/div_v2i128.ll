...
; GISEL-NEXT:    v_mul_lo_u32 v36, v30, v19
...
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v29, v32, v[14:15]
; GISEL-NEXT:    v_mov_b32_e32 v26, v1
; GISEL-NEXT:    v_mad_u64_u32 v[24:25], s[4:5], v34, v21, v[24:25]
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v10, v31, v[14:15]
; GISEL-NEXT:    v_mad_u64_u32 v[24:25], s[4:5], v4, v20, v[24:25]
; GISEL-NEXT:    v_mov_b32_e32 v27, v14
; GISEL-NEXT:    v_mad_u64_u32 v[26:27], vcc, v30, v32, v[26:27]
; GISEL-NEXT:    v_mad_u64_u32 v[23:24], s[4:5], v35, v21, v[23:24]
; GISEL-NEXT:    v_mad_u64_u32 v[26:27], s[6:7], v29, v31, v[26:27]
; GISEL-NEXT:    v_addc_u32_e64 v1, s[6:7], v15, v36, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[6:7], v34, v20, v[23:24]
; GISEL-NEXT:    v_addc_u32_e64 v3, s[6:7], v25, v3, s[6:7]
; GISEL-NEXT:    v_addc_u32_e32 v18, vcc, v1, v18, vcc
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v16, v0
; GISEL-NEXT:    v_subb_u32_e32 v16, vcc, v17, v26, vcc
; GISEL-NEXT:    v_xor_b32_e32 v0, v0, v28
; GISEL-NEXT:    v_addc_u32_e64 v1, s[4:5], v3, v37, s[4:5]
...
; GISEL-NEXT:    v_xor_b32_e32 v16, v16, v28
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[6:7], v4, v21, v[1:2]
...
; GISEL-NEXT:    v_subb_u32_e64 v1, s[6:7], v16, v28, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v5, v20, v[2:3]
; GISEL-NEXT:    v_sub_i32_e64 v4, s[8:9], v17, v33
; GISEL-NEXT:    v_subb_u32_e64 v5, s[8:9], v14, v33, s[8:9]
; GISEL-NEXT:    v_subb_u32_e32 v3, vcc, v8, v27, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v36, v13, v18
; GISEL-NEXT:    ; implicit-def: $vgpr18
; GISEL-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v9, v33, v[22:23]
; GISEL-NEXT:    v_mov_b32_e32 v30, v17
; GISEL-NEXT:    v_mad_u64_u32 v[28:29], s[4:5], v13, v25, v[28:29]
; GISEL-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v10, v32, v[21:22]
; GISEL-NEXT:    v_mad_u64_u32 v[28:29], s[4:5], v14, v24, v[28:29]
; GISEL-NEXT:    v_mov_b32_e32 v31, v21
; GISEL-NEXT:    v_mad_u64_u32 v[30:31], vcc, v8, v33, v[30:31]
; GISEL-NEXT:    v_mad_u64_u32 v[27:28], s[4:5], v12, v25, v[27:28]
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[6:7], v9, v32, v[30:31]
; GISEL-NEXT:    v_addc_u32_e64 v17, s[6:7], v22, v34, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[6:7], v13, v24, v[27:28]
; GISEL-NEXT:    v_addc_u32_e64 v21, s[6:7], v29, v19, s[6:7]
; GISEL-NEXT:    v_addc_u32_e32 v19, vcc, v17, v35, vcc
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v0, v16
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v1, v8, vcc
; GISEL-NEXT:    v_addc_u32_e64 v17, s[4:5], v21, v36, s[4:5]
; GISEL-NEXT:    v_sub_i32_e64 v4, s[4:5], v4, v26
; GISEL-NEXT:    v_subb_u32_e64 v5, s[4:5], v5, v12, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[19:20], s[6:7], v10, v33, v[19:20]
; GISEL-NEXT:    v_mad_u64_u32 v[16:17], s[6:7], v14, v25, v[17:18]
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[6:7], v11, v32, v[19:20]
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[6:7], v15, v24, v[16:17]
