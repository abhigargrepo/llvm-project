...
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr3
; GCN-NOHSA-VI-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[14:15], s[4:5], 0x100000
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s4
; GCN-NOHSA-VI-NEXT:    s_add_u32 s4, s0, 32
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s5
; GCN-NOHSA-VI-NEXT:    s_addc_u32 s5, s1, 0
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[4:5], 0x100000
; GFX12-NEXT:    s_lshr_b32 s2, s4, 16
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[6:7], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[8:9], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[10:11], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[12:13], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[14:15], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[16:17], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v1, s5
; GFX12-NEXT:    v_dual_mov_b32 v4, s18 :: v_dual_mov_b32 v9, s13
; GFX12-NEXT:    v_dual_mov_b32 v8, s12 :: v_dual_mov_b32 v11, s15
; GFX12-NEXT:    v_dual_mov_b32 v10, s14 :: v_dual_mov_b32 v3, s11
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v5, s19
; GFX12-NEXT:    v_dual_mov_b32 v2, s10 :: v_dual_mov_b32 v13, s7
; GFX12-NEXT:    v_dual_mov_b32 v12, s6 :: v_dual_mov_b32 v15, s9
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s33
...
; GCN-HSA-NEXT:    s_ashr_i32 s28, s1, 31
...
; GFX12-NEXT:    s_lshr_b32 s16, s2, 16
...
; GFX12-NEXT:    s_bfe_i64 s[36:37], s[0:1], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[0:1], s[2:3], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[6:7], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[4:5], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[10:11], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[12:13], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[14:15], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[16:17], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[16:17], s[18:19], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[20:21], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[20:21], s[22:23], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[24:25], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[26:27], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[26:27], s[28:29], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[30:31], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[30:31], s[34:35], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s7
; GFX12-NEXT:    v_dual_mov_b32 v4, s2 :: v_dual_mov_b32 v9, s29
...
; GFX12-NEXT:    v_dual_mov_b32 v2, s26 :: v_dual_mov_b32 v13, s23
; GFX12-NEXT:    v_dual_mov_b32 v12, s22 :: v_dual_mov_b32 v15, s25
; GFX12-NEXT:    v_dual_mov_b32 v14, s24 :: v_dual_mov_b32 v7, s21
; GFX12-NEXT:    v_dual_mov_b32 v6, s20 :: v_dual_mov_b32 v17, s17
; GFX12-NEXT:    v_dual_mov_b32 v16, s16 :: v_dual_mov_b32 v19, s19
; GFX12-NEXT:    v_mov_b32_e32 v18, s18
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[8:9] offset:80
; GFX12-NEXT:    global_store_b128 v24, v[0:3], s[8:9] offset:64
; GFX12-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v3, s15
; GFX12-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_mov_b32 v2, s14
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s1, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s50, s1, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s51, s3, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s52, s3, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s53, s5, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s54, s5, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s55, s7, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s56, s7, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s57, s9, 31
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[48:49], s[24:25], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[62:63], s[22:23], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s23, s13, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s25, s13, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s27, s15, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s29, s15, 16
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s42, s5
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v20, s58
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s53
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s51
...
; GCN-HSA-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x0
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    s_mov_b32 s26, s15
...
; GCN-HSA-NEXT:    s_ashr_i32 s76, s11, 16
; GCN-HSA-NEXT:    s_ashr_i32 s77, s13, 31
; GCN-HSA-NEXT:    s_ashr_i32 s78, s13, 16
; GCN-HSA-NEXT:    s_ashr_i32 s79, s15, 31
; GCN-HSA-NEXT:    s_ashr_i32 s80, s15, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x100000
...
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[56:57], 0x100000
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s80
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s79
...
; GCN-HSA-NEXT:    s_add_u32 s24, s16, 0x90
...
; GCN-HSA-NEXT:    s_add_u32 s24, s16, 0x80
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, s51
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s78
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s77
; GCN-HSA-NEXT:    s_addc_u32 s25, s17, 0
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s76
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s34, s2, 16
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s36, s3
...
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[42:43], s[12:13], 0x100000
...
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[10:11], s[34:35], 0x100000
...
; GCN-NOHSA-VI-NEXT:    s_add_u32 s42, s16, 0xc0
...
; GCN-NOHSA-VI-NEXT:    s_add_u32 s42, s16, 0xb0
; GCN-NOHSA-VI-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GCN-NOHSA-VI-NEXT:    s_addc_u32 s43, s17, 0
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v4, s42
...
; GCN-NOHSA-VI-NEXT:    s_nop 0
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s30
; GCN-NOHSA-VI-NEXT:    s_add_u32 s30, s16, 0xa0
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s31
...
; GCN-NOHSA-VI-NEXT:    s_add_u32 s30, s16, 0x90
; GCN-NOHSA-VI-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GCN-NOHSA-VI-NEXT:    s_addc_u32 s31, s17, 0
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v4, s30
...
; GFX12-NEXT:    s_load_b512 s[0:15], s[18:19], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mov_b32 s28, s1
; GFX12-NEXT:    s_lshr_b32 s34, s2, 16
; GFX12-NEXT:    s_lshr_b32 s40, s3, 16
; GFX12-NEXT:    s_lshr_b32 s50, s5, 16
; GFX12-NEXT:    s_lshr_b32 s52, s6, 16
; GFX12-NEXT:    s_mov_b32 s54, s7
; GFX12-NEXT:    s_lshr_b32 s62, s9, 16
; GFX12-NEXT:    s_lshr_b32 s64, s10, 16
; GFX12-NEXT:    s_mov_b32 s66, s11
; GFX12-NEXT:    s_lshr_b32 s24, s0, 16
...
; GFX12-NEXT:    s_mov_b32 s60, s9
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[28:29], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[34:35], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[40:41], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[50:51], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[34:35], s[52:53], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[40:41], s[54:55], 0x100000
...
; GFX12-NEXT:    s_bfe_i64 s[46:47], s[10:11], 0x100000
; GFX12-NEXT:    s_lshr_b32 s44, s11, 16
; GFX12-NEXT:    s_bfe_i64 s[0:1], s[24:25], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[30:31], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[38:39], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[42:43], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[30:31], s[48:49], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[38:39], s[56:57], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[42:43], s[58:59], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[48:49], s[60:61], 0x100000
...
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[44:45], 0x100000
; GFX12-NEXT:    s_clause 0x3
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s54 :: v_dual_mov_b32 v3, s13
; GFX12-NEXT:    v_dual_mov_b32 v1, s55 :: v_dual_mov_b32 v2, s12
; GFX12-NEXT:    v_dual_mov_b32 v5, s47 :: v_dual_mov_b32 v4, s46
...
; GFX12-NEXT:    v_dual_mov_b32 v13, s21 :: v_dual_mov_b32 v12, s20
; GFX12-NEXT:    v_dual_mov_b32 v15, s7 :: v_dual_mov_b32 v14, s6
; GFX12-NEXT:    v_dual_mov_b32 v17, s5 :: v_dual_mov_b32 v16, s4
; GFX12-NEXT:    v_dual_mov_b32 v19, s3 :: v_dual_mov_b32 v18, s2
