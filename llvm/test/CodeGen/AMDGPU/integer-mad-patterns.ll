...
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v8, vcc, v4, v7, vcc
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v1, v3, v[6:7]
...
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v8, vcc, v4, v7, vcc
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v1, v3, v[6:7]
...
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v8, vcc, v4, v7, vcc
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v1, v3, v[6:7]
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr1
...
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v3, v9, v[1:2]
...
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v8, null, v4, v7, vcc_lo
; GFX10-GISEL-NEXT:    v_add_co_u32 v9, vcc_lo, v0, 1
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v10, null, 0, v4, vcc_lo
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v1, v3, v[6:7]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v5, v9, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX10-GISEL-NEXT:    v_add_co_u32 v11, vcc_lo, v5, 1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v8, v2, v[6:7]
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v7, v4
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v3, v11, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v5, v10, v[7:8]
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v12, null, 0, v6, vcc_lo
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], null, v3, v12, v[1:2]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v6, v9, v[4:5]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], null, v4, v11, v[1:2]
; GFX10-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v10, null, v4, v9, vcc_lo
...
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v12, null, 0, v4, vcc_lo
...
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v14, null, 0, v6, vcc_lo
...
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v5, v[8:9]
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v10, v3
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v7, v[10:11]
...
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v9, v15, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v1, v5, v[11:12]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr15
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v16, v7, v[14:15]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v3, v4, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v17, v6, v[14:15]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v11, vcc, 1, v0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v11, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v8, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v12, vcc, 1, v2
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v0, v6
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v7, v[0:1]
...
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v5, v15, v[10:11]
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v10, v3
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v6, v17, v[10:11]
...
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v5, v[8:9]
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v10, v3
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v7, v[10:11]
...
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v9, v15, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v1, v5, v[11:12]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr15
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v16, v7, v[14:15]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v3, v4, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v17, v6, v[14:15]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v11, vcc, 1, v0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v11, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v8, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v12, vcc, 1, v2
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v0, v6
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v7, v[0:1]
...
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v5, v15, v[10:11]
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v10, v3
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v6, v17, v[10:11]
...
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v8, v1
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v1, vcc, v0, v12
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v5, v[8:9]
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v10, v3
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v7, v[10:11]
...
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v17, vcc, v9, v15, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v1, v5, v[11:12]
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr15
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v16, v7, v[14:15]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v3, v4, v[11:12]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v17, v6, v[14:15]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v11, vcc, 1, v0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v11, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v8, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v12, vcc, 1, v2
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v0, v6
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v7, v[0:1]
...
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v5, v15, v[10:11]
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v10, v3
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v6, v17, v[10:11]
...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[10:11], null, v14, v7, v[10:11]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[8:9], null, v13, v4, v[8:9]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v15, v6, v[10:11]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[10:11], null, v3, v4, 0
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v17, null, v8, v13, vcc_lo
; GFX10-GISEL-NEXT:    v_add_co_u32 v18, vcc_lo, v2, v14
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v19, null, v9, v15, vcc_lo
; GFX10-GISEL-NEXT:    v_add_co_u32 v20, vcc_lo, v0, 1
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, v11
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[12:13], null, v18, v6, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[15:16], null, v10, v20, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v3, v5, v[0:1]
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v21, null, 0, v8, vcc_lo
; GFX10-GISEL-NEXT:    v_add_co_u32 v11, vcc_lo, v2, 1
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr14
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[7:8], null, v18, v7, v[13:14]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v17, v4, v[0:1]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v12, v11, 0
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, v16
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v9, vcc_lo
; GFX10-GISEL-NEXT:    v_add_co_u32 v16, vcc_lo, v10, 1
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v19, v6, v[7:8]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v10, v21, v[0:1]
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v7, v14
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v15, v16, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v17, null, 0, v4, vcc_lo
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[8:9], null, v12, v9, v[7:8]
; GFX10-GISEL-NEXT:    v_add_co_u32 v18, vcc_lo, v12, 1
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v19, null, 0, v5, vcc_lo
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v4, v20, v[6:7]
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v4, v1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v13, v18, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[7:8], null, v5, v11, v[8:9]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[8:9], null, v15, v17, v[4:5]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v13, v19, v[3:4]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v6, v16, v[8:9]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v7, v18, v[3:4]
...
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v18, null, v10, v15, vcc_lo
; GFX11-GISEL-NEXT:    v_add_co_u32 v19, vcc_lo, v2, v16
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v17, null, v11, v17, vcc_lo
...
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[15:16], null, v3, v5, v[0:1]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v19, v7, v[13:14]
; GFX11-GISEL-NEXT:    v_add_co_u32 v19, vcc_lo, v2, 1
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr16
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v2, v10
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v22, null, 0, v11, vcc_lo
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v18, v4, v[15:16]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v12, v19, 0
; GFX11-GISEL-NEXT:    v_add_co_u32 v16, vcc_lo, v8, 1
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[10:11], null, v17, v6, v[0:1]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr3
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v8, v21, v[2:3]
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v7, v5
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v17, null, 0, v13, vcc_lo
; GFX11-GISEL-NEXT:    v_add_co_u32 v18, vcc_lo, v12, 1
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v9, v16, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[14:15], null, v12, v22, v[7:8]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v4, v18, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[11:12], null, v13, v20, v[6:7]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v5, v1
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr15
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v23, null, 0, v10, vcc_lo
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[12:13], null, v10, v19, v[14:15]
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v7, v3
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr6
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v9, v17, v[5:6]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr14
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v4, v23, v[7:8]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr10
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v11, v16, v[13:14]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
