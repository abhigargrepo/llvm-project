...
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v8, v4
; CHECK-NEXT:    ; implicit-def: $vgpr4
; CHECK-NEXT:    v_sub_i32_e32 v2, vcc, v5, v2
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v0, v6, v[3:4]
...
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s8, v3, v[1:2]
...
; GISEL-NEXT:    v_subb_u32_e32 v13, vcc, 0, v8, vcc
...
; GISEL-NEXT:    v_cvt_u32_f32_e32 v14, v11
; GISEL-NEXT:    ; implicit-def: $vgpr11
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v12, v4, 0
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v12, v14, v[10:11]
; GISEL-NEXT:    v_mul_hi_u32 v16, v4, v9
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v4, v[10:11]
...
; GISEL-NEXT:    v_mul_lo_u32 v16, v14, v10
...
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v12, v15, 0
; GISEL-NEXT:    ; implicit-def: $vgpr11
...
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v14, v4
; CGP-NEXT:    ; implicit-def: $vgpr4
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v11, v2
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v0, v5, v[3:4]
...
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v12, v6
; CGP-NEXT:    ; implicit-def: $vgpr6
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v9, v4
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v7, v[5:6]
...
; GISEL-NEXT:    v_addc_u32_e32 v16, vcc, v9, v8, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr15
; GISEL-NEXT:    v_mul_lo_u32 v8, v16, v13
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v6, v16, v[14:15]
...
; GISEL-NEXT:    v_add_i32_e32 v17, vcc, v17, v8
...
; GISEL-NEXT:    v_xor_b32_e32 v18, v0, v8
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v14, v0
; GISEL-NEXT:    v_xor_b32_e32 v7, v13, v8
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v5, v0
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v1, v0
; GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GISEL-NEXT:    ; implicit-def: $vgpr1
...
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v14, v5, vcc
; GISEL-NEXT:    v_sub_i32_e64 v5, s[4:5], v14, v5
...
; CHECK-NEXT:    v_sub_i32_e32 v8, vcc, 0, v0
; CHECK-NEXT:    v_subb_u32_e32 v9, vcc, 0, v1, vcc
...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v10, v7
; CHECK-NEXT:    ; implicit-def: $vgpr7
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v2, 0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v10, v[6:7]
; CHECK-NEXT:    v_mul_hi_u32 v11, v2, v5
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v9, v2, v[6:7]
...
; CHECK-NEXT:    v_mul_hi_u32 v2, v11, v2
; CHECK-NEXT:    v_mul_hi_u32 v9, v11, v3
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v9, v4
; CHECK-NEXT:    ; implicit-def: $vgpr4
; CHECK-NEXT:    v_sub_i32_e32 v2, vcc, v7, v2
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v0, v5, v[3:4]
...
; GISEL-NEXT:    v_subb_u32_e32 v14, vcc, 0, v7, vcc
...
; GISEL-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GISEL-NEXT:    v_cvt_u32_f32_e32 v15, v12
; GISEL-NEXT:    ; implicit-def: $vgpr12
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v4, 0
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v13, v15, v[11:12]
; GISEL-NEXT:    v_mul_hi_u32 v17, v4, v10
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v4, v[11:12]
...
; GISEL-NEXT:    v_mul_hi_u32 v16, v4, v11
...
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v16, v0
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v15, v1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v13, v14, v10
; GISEL-NEXT:    v_mul_lo_u32 v15, v12, v11
; GISEL-NEXT:    v_lshl_b64 v[0:1], v[8:9], v6
; GISEL-NEXT:    v_mul_hi_u32 v6, v12, v10
; GISEL-NEXT:    v_mul_hi_u32 v10, v14, v10
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v13, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
...
; GISEL-NEXT:    v_mac_f32_e32 v15, 0x4f800000, v16
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v10, v15
...
; GISEL-NEXT:    ; implicit-def: $vgpr12
; GISEL-NEXT:    v_subb_u32_e64 v17, s[4:5], v14, v0, vcc
...
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v17, v7
...
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], v17, v7
...
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v13, v10, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v12
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v9, v5, vcc
; GISEL-NEXT:    v_mov_b32_e32 v9, v1
; GISEL-NEXT:    ; implicit-def: $vgpr10
; GISEL-NEXT:    v_ashrrev_i32_e32 v12, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v15, v13, v[9:10]
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v15, v12
; CGP-NEXT:    ; implicit-def: $vgpr12
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v4, 0
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v13, v15, v[11:12]
; CGP-NEXT:    v_mul_hi_u32 v16, v4, v10
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v4, v[11:12]
...
; CGP-NEXT:    v_mul_hi_u32 v14, v16, v8
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
...
; CGP-NEXT:    ; implicit-def: $vgpr10
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v0, v11, v[9:10]
...
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v8, v6
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v12, v6
; CGP-NEXT:    ; implicit-def: $vgpr6
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v10, v4
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v8, v[5:6]
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v10, v3, 0
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v10, v5, v[8:9]
; GISEL-NEXT:    v_mul_hi_u32 v12, v3, v7
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v11, v3, v[8:9]
...
; GISEL-NEXT:    v_mul_hi_u32 v12, v3, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
...
; GISEL-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v4
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v1, v8, v[6:7]
; GISEL-NEXT:    v_mul_f32_e32 v8, 0x2f800000, v4
; GISEL-NEXT:    v_trunc_f32_e32 v11, v8
; GISEL-NEXT:    v_mac_f32_e32 v4, 0xcf800000, v11
...
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v13, v11, v[9:10]
; GISEL-NEXT:    v_sub_i32_e32 v7, vcc, v0, v5
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v12, v[9:10]
; GISEL-NEXT:    v_subb_u32_e64 v15, s[4:5], 0, v6, vcc
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], 0, v6
; GISEL-NEXT:    v_mul_lo_u32 v5, v11, v8
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v10, v11, v4
...
; GISEL-NEXT:    v_addc_u32_e64 v10, s[4:5], v11, v4, s[4:5]
...
; GISEL-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; GISEL-NEXT:    v_mul_hi_u32 v14, v8, v4
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v14, v10, v5
...
; GISEL-NEXT:    v_mul_hi_u32 v13, v2, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
...
; GISEL-NEXT:    v_mov_b32_e32 v0, v5
; GISEL-NEXT:    v_cndmask_b32_e32 v11, v11, v1, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr1
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v3, v6, v[0:1]
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v7, v11, vcc
