...
; GFX7-NEXT:    v_addc_u32_e32 v11, vcc, v0, v16, vcc
; GFX7-NEXT:    ; implicit-def: $vgpr12
; GFX7-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v7, v8, v[11:12]
...
; GFX8-NEXT:    v_addc_u32_e32 v11, vcc, v0, v16, vcc
; GFX8-NEXT:    ; implicit-def: $vgpr12
; GFX8-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v7, v8, v[11:12]
...
; GFX9-NEXT:    v_addc_co_u32_e32 v11, vcc, v0, v16, vcc
; GFX9-NEXT:    ; implicit-def: $vgpr12
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v7, v8, v[11:12]
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v6, 0
; GFX7-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; GFX7-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v6, v[3:4]
; GFX7-NEXT:    buffer_store_dwordx2 v[2:3], v[0:1], s[0:3], 0 addr64
; GFX7-NEXT:    s_endpgm
;
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v5, v6, 0
; GFX8-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], v5, v6, v[3:4]
; GFX8-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v5, v6, 0
; GFX9-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], v5, v6, v[3:4]
; GFX9-NEXT:    global_store_dwordx2 v[0:1], v[2:3], off
; GFX9-NEXT:    s_endpgm
;
