...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v11, v8
; CHECK-NEXT:    ; implicit-def: $vgpr8
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v9, v3, 0
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v9, v11, v[7:8]
; CHECK-NEXT:    v_mul_hi_u32 v12, v3, v6
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v10, v3, v[7:8]
...
; CHECK-NEXT:    v_xor_b32_e32 v12, v5, v9
...
; CHECK-NEXT:    v_cndmask_b32_e64 v5, v8, v10, s[4:5]
...
; CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v5, v2
; CHECK-NEXT:    ; implicit-def: $vgpr2
; CHECK-NEXT:    v_mov_b32_e32 v5, s13
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s10, v3, v[1:2]
...
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, 0, v10
...
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v5, 0
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v9, v[12:13]
; GISEL-NEXT:    v_mul_hi_u32 v17, v5, v11
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v5, v[12:13]
...
; GISEL-NEXT:    v_addc_u32_e32 v16, vcc, v9, v12, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v5, 0
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_ashrrev_i32_e32 v9, 31, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v9
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v16, v[12:13]
...
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, v16, v11, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v5, v13
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_ashrrev_i32_e32 v5, 31, v7
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v10, v15, v[12:13]
...
; GISEL-NEXT:    v_mac_f32_e32 v13, 0x4f800000, v16
...
; GISEL-NEXT:    v_cvt_u32_f32_e32 v20, v13
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[6:7], v18, v16, 0
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_subb_u32_e32 v19, vcc, 0, v6, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[6:7], v18, v20, v[12:13]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v14, v10
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, v14, v10
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[6:7], v19, v16, v[12:13]
...
; GISEL-NEXT:    v_mul_lo_u32 v14, v20, v12
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v14, v11
; GISEL-NEXT:    v_mul_hi_u32 v14, v16, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v17, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v12, v20, v12
...
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v14, v11
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v12, v11
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v16, v10
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v20, v11, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v18, v12, 0
...
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v14, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v15, v13, vcc
; GISEL-NEXT:    v_xor_b32_e32 v9, v4, v8
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v12, v[0:1]
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v6, v9, v[10:11]
...
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v6, v8, v[14:15]
...
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v8, v16, v[13:14]
...
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v15, v13, vcc
; GISEL-NEXT:    v_mov_b32_e32 v9, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v16, v5, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr10
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v6, v11, v[9:10]
...
; GISEL-NEXT:    v_xor_b32_e32 v9, v12, v4
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, v3, v10, vcc
; GISEL-NEXT:    v_xor_b32_e32 v12, v1, v10
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v2, v11, v5
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
...
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_mul_hi_u32 v3, v11, v5
...
; GISEL-NEXT:    v_mul_lo_u32 v2, v14, v0
; GISEL-NEXT:    v_mul_lo_u32 v3, v12, v1
; GISEL-NEXT:    v_mul_hi_u32 v5, v12, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v14, v0
; GISEL-NEXT:    v_xor_b32_e32 v7, v13, v4
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; GISEL-NEXT:    v_mul_hi_u32 v3, v12, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v5, v0
...
; GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GISEL-NEXT:    ; implicit-def: $vgpr1
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v13, v[0:1]
...
; CGP-NEXT:    v_addc_u32_e32 v16, vcc, v8, v9, vcc
; CGP-NEXT:    ; implicit-def: $vgpr15
; CGP-NEXT:    v_mul_lo_u32 v9, v16, v13
; CGP-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v6, v16, v[14:15]
...
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v17, v9
...
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v13, v17
...
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v7, 0
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v16, v[12:13]
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v7, v[12:13]
; GISEL-NEXT:    v_mul_lo_u32 v13, v16, v11
; GISEL-NEXT:    v_mul_lo_u32 v17, v7, v12
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v13, v17
...
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v13, v17
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v17, v16, v12
...
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; GISEL-NEXT:    v_add_i32_e32 v17, vcc, v7, v11
; GISEL-NEXT:    v_addc_u32_e32 v16, vcc, v16, v12, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v17, 0
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_ashrrev_i32_e32 v7, 31, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v7
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v16, v[12:13]
; GISEL-NEXT:    v_xor_b32_e32 v14, v0, v7
; GISEL-NEXT:    v_mul_lo_u32 v0, v16, v11
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v17, v[12:13]
; GISEL-NEXT:    v_mul_hi_u32 v15, v17, v11
...
; GISEL-NEXT:    v_mul_lo_u32 v15, v16, v12
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v13, v0
; GISEL-NEXT:    v_mul_hi_u32 v13, v17, v12
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v15, v11
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
...
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v16, v11, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v15, v1, v11
...
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v13, v15
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v16, v13
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v9, v6
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v8, v15, v[12:13]
...
; GISEL-NEXT:    v_cvt_f32_u32_e32 v16, v9
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, v14, v11
; GISEL-NEXT:    v_subb_u32_e64 v17, s[4:5], v1, v12, vcc
; GISEL-NEXT:    v_mac_f32_e32 v13, 0x4f800000, v16
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v11, v13
...
; GISEL-NEXT:    v_mac_f32_e32 v11, 0xcf800000, v13
; GISEL-NEXT:    v_cvt_u32_f32_e32 v16, v11
; GISEL-NEXT:    v_sub_i32_e32 v18, vcc, 0, v10
; GISEL-NEXT:    v_cvt_u32_f32_e32 v20, v13
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[6:7], v18, v16, 0
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_subb_u32_e32 v19, vcc, 0, v9, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[6:7], v18, v20, v[12:13]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v14, v8
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, v14, v8
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[6:7], v19, v16, v[12:13]
; GISEL-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v14, v8
; GISEL-NEXT:    v_mul_lo_u32 v8, v20, v11
; GISEL-NEXT:    v_mul_lo_u32 v13, v16, v12
...
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v16, v11
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v20, v12, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v18, v13, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v13, v10
; CGP-NEXT:    ; implicit-def: $vgpr10
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v11, v6, 0
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v11, v13, v[9:10]
; CGP-NEXT:    v_mul_hi_u32 v14, v6, v8
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v12, v6, v[9:10]
...
; CGP-NEXT:    v_xor_b32_e32 v14, v7, v11
...
; CGP-NEXT:    v_mul_hi_u32 v12, v14, v6
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v7, v8
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v8, v7
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v12, v7
; CGP-NEXT:    ; implicit-def: $vgpr7
...
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v7, v3
; CGP-NEXT:    v_subbrev_u32_e32 v6, vcc, 0, v6, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v7, v10, v12, s[4:5]
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v4, v[8:9]
...
; GISEL-NEXT:    v_mul_lo_u32 v16, v14, v6
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v15, v7
; GISEL-NEXT:    v_mul_hi_u32 v15, v2, v6
...
; GISEL-NEXT:    v_mul_hi_u32 v13, v11, v2
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, 1, v12
...
; GISEL-NEXT:    v_mul_hi_u32 v13, v11, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v6, v2
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v13
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v2, v5
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v3, v13, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
...
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], 0, v13, v[6:7]
